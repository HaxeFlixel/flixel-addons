...
class FlxGridOverlay 
{
	 ...
	 */
	public static function create(CellWidth:Int, CellHeight:Int, Width:Int = -1, Height:Int = -1,
		Alternate:Bool = true, Color1:FlxColor = 0xffe7e6e6, Color2:FlxColor = 0xffd9d5d5):FlxSprite
	{
		if (Width == -1)
		{
			Width = FlxG.width;
	 ...
	 */
	public static function overlay(Sprite:FlxSprite, CellWidth:Int, CellHeight:Int, Width:Int = -1,
		Height:Int = -1, Alternate:Bool = true, Color1:FlxColor = 0x88e7e6e6, Color2:FlxColor = 0x88d9d5d5):FlxSprite
	{
		if (Width == -1)
		{
			Width = FlxG.width;
	...
	public static function createGrid(CellWidth:Int, CellHeight:Int, Width:Int, Height:Int, Alternate:Bool,
		Color1:FlxColor, Color2:FlxColor):BitmapData
	{
